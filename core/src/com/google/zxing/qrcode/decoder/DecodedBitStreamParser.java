...
final class DecodedBitStreamParser {
    ...
    private static void decodeByteSegment(BitSource bits, StringBuffer result, int count,
            CharacterSetECI currentCharacterSetECI, Vector<byte[]> byteSegments,
            Hashtable<?, ?> hints) throws FormatException {
     ...
     */
    private static void decodeHanziSegment(BitSource bits, StringBuffer result, int count)
    ...
    private static void decodeKanjiSegment(BitSource bits, StringBuffer result, int count)
            throws FormatException {
        // Don't crash trying to read more bits than we have available.
        if (count * 13 > bits.available()) {
            throw FormatException.getFormatInstance();
    ...
    private static void decodeNumericSegment(BitSource bits, StringBuffer result, int count)
            throws FormatException {
