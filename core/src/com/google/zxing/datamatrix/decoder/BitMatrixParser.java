...
final class BitMatrixParser {
     ...
     * @throws FormatException if the dimensions of the mapping matrix are not
     *             valid Data Matrix dimensions.
     */
     ...
     * </p>
     * 
     * @param row Current row in the mapping matrix, anchored at the 8th bit
     *            (LSB) of the pattern
     * @param column Current column in the mapping matrix, anchored at the 8th
     *            bit (LSB) of the pattern
     * @param numRows Number of rows in the mapping matrix
     * @param numColumns Number of columns in the mapping matrix
