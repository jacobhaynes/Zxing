...
public abstract class OneDReader implements Reader {
     ...
     * @throws NotFoundException if counters cannot be filled entirely from row
     *             before running out of pixels
     */
            ...
            for (int attempt = 0; attempt < 2; attempt++) {
                if (attempt == 1) { // trying again?
                    ...
                    if (hints != null
                        ...
                        Hashtable newHints = new Hashtable<Object, Object>(); // Can't
                                                                              // use
                                                                              // clone()
                                                                              // in
                                                                              // J2ME
