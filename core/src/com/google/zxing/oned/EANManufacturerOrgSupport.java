...
final class EANManufacturerOrgSupport {
    ...
    private final Vector<int[]> ranges = new Vector<int[]>();
    private final Vector<String> countryIdentifiers = new Vector<String>();
    ...
    String lookupCountryIdentifier(String productCode) {
        ...
        for (int i = 0; i < max; i++) {
            ...
            if (prefix <= end) {
                return countryIdentifiers.elementAt(i);
            }
        }
        return null;
    }
