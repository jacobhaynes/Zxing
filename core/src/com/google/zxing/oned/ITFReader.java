...
public final class ITFReader extends OneDReader {
    ...
    /**
     * Start/end guard pattern. Note: The end pattern is reversed because the
     ...
     * @throws NotFoundException Throws exception if no black lines are found in
     *             the row
     */
     ...
     * number of quiet zone pixels. Note: Its assumed the row is reversed when
     * using this method to find quiet zone after the end pattern. ref:
     * http://www.barcode-1.net/i25code.html
     * 
     * @param row bit array representing the scanned barcode.
     * @param startPattern index into row of the start or end pattern.
     * @throws NotFoundException if the quiet zone cannot be found, a
