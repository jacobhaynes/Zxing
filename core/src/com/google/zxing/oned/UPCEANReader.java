...
public abstract class UPCEANReader extends OneDReader {
     ...
     * @param counters the counts of runs of observed black/white/black/...
     *            values
     * @param rowOffset horizontal offset to start decoding from
     * @param patterns the set of patterns to use to decode -- sometimes
     *            different encodings for the digits 0-9 are used, and this
     *            indicates the encodings for 0 to 9 that should be used
     ...
     * @param whiteFirst if true, indicates that the pattern specifies
     *            white/black/white/... pixel counts, otherwise, it is
     *            interpreted as black/white/black/...
     * @param pattern pattern of counts of number of black and white pixels that
     *            are being searched for as a pattern
    ...
    public Result decodeRow(int rowNumber, BitArray row, int[] startGuardRange,
            Hashtable<?, ?> hints) throws NotFoundException, ChecksumException, FormatException {

        ResultPointCallback resultPointCallback = hints == null ? null : (ResultPointCallback)hints
