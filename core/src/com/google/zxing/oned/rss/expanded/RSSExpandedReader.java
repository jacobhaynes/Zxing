...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private boolean checkPairSequence(Vector<ExpandedPair> previousPairs, FinderPattern pattern)
    ...
    private void findNextPair(BitArray row, Vector<ExpandedPair> previousPairs, int forcedOffset)
            throws NotFoundException {
    ...
    // not private for testing
    ExpandedPair retrieveNextPair(BitArray row, Vector<ExpandedPair> previousPairs, int rowNumber)
            throws NotFoundException {
