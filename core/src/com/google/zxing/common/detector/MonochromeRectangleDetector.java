...
public final class MonochromeRectangleDetector {
     ...
     * 
     * @param fixedDimension if scanning horizontally, this is the row (the
     *            fixed vertical location) where we are scanning. If scanning
     *            vertically it's the column, the fixed horizontal location
     * @param maxWhiteRun largest run of white pixels that can still be
     *            considered part of the barcode region
     * @param minDim minimum pixel location, horizontally or vertically, to
     *            consider
     * @param maxDim maximum pixel location, horizontally or vertically, to
     *            consider
     ...
     * @param deltaY change in y per step. If scanning up this is negative;
     *            down, positive; left or right, 0
     * @param top minimum value of y to search through (meaningless when di ==
     *            0)
     * @param bottom maximum value of y
     * @param maxWhiteRun maximum run of white pixels that can still be
     *            considered to be within the barcode
