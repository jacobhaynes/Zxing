...
final class DecodedBitStreamParser {
     ...
     * 1 d1 = 1 111 348 109 082 mod 900 = 282 t = 1 111 348 109 082 div 900 = 1
     * 234 831 232 Calculate codeword 2 d2 = 1 234 831 232 mod 900 = 632 t = 1
     * 234 831 232 div 900 = 1 372 034 Calculate codeword 3 d3 = 1 372 034 mod
     * 900 = 434 t = 1 372 034 div 900 = 1 524 Calculate codeword 4 d4 = 1 524
     * mod 900 = 624 t = 1 524 div 900 = 1 Calculate codeword 5 d5 = 1 mod 900 =
     * 1 t = 1 div 900 = 0 Codeword sequence is: 1, 624, 434, 632, 282, 200
     ...
     * + 200 x 900 power of 0 = 1000213298174000 Remove leading 1 => Result is
     * 000213298174000 As there are huge numbers involved here we must use fake
     * out the maths using string tokens for the numbers. BigDecimal is not
     * supported by J2ME.
     */
     ...
     * @param byteCompactionData The byte compaction data if there was a mode
     *            shift.
     * @param length The size of the text compaction and byte compaction data.
     * @param result The decoded data is appended to the result.
     */
    private static void decodeTextCompaction(int[] textCompactionData, int[] byteCompactionData,
            int length, StringBuffer result) {
