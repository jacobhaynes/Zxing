...
public class PDF417_size {
    ...
    protected void detect(int dataLength, int eccLevel) {
        ...
        /*
         * Autodetection is simple math task: minimizing expression ((4+w) * 17
         * + 1 )* h under certain conditions w * h <= len; 3 <= h <= 90 1 <= w
         * <= 30 the first thing came to mind is brute-force. todo: write
         * complete (brute-force) test for testing this method. It shall help in
         * optimizing this method. By the way: lookup table seems good solution,
         * since it need only 928 values, less then 4 kb.
         */
        int c, w, h;
        int mc, mw, mh;
