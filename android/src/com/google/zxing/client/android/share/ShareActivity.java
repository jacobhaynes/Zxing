...
public final class ShareActivity extends Activity {
    ...
    final String[] emailProjection = new String[] {
            ContactsContract.CommonDataKinds.Email.DATA, // use Email.ADDRESS
                                                         // for API-Level 11+
            ContactsContract.CommonDataKinds.Email.TYPE
    };

    final String[] addressProjection = new String[] {
            ContactsContract.CommonDataKinds.StructuredPostal.FORMATTED_ADDRESS, // use
                                                                                 // Email.ADDRESS
                                                                                 // for
                                                                                 // API-Level
                                                                                 // 11+
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (barcodeFormat.equals(BarcodeFormat.PDF_417.toString())) {
            menu.add(0, QR_CODE, 0, "QR Code").setIcon(
                    android.R.drawable.radiobutton_off_background);
            menu.add(0, PDF_417, 0, "PDF417").setIcon(android.R.drawable.radiobutton_on_background);
        } else {
            menu.add(0, QR_CODE, 0, "QR Code")
                    .setIcon(android.R.drawable.radiobutton_on_background);
            menu.add(0, PDF_417, 0, "PDF 417").setIcon(
                    android.R.drawable.radiobutton_off_background);
        }
        return true;
    }
    ...
    private void showContactAsBarcode(Uri contactUri) {
        ...
        if (contactCursor != null && contactCursor.moveToFirst()) {
            ...
            if (nameColumn >= 0) {
                ...
                int contactIdColumnIndex = contactCursor
             ...
             * Contacts.People.ContactMethods.CONTENT_DIRECTORY); String
             * phonesURI = phonesUri.toString(); String phoneURI2 =
            ...
            final Cursor phoneCursor = managedQuery(
                    ...
                    ContactsContract.Data.CONTACT_ID + "=?", new String[] {
            ...
            if (emailCursor.moveToFirst()) {
                final int contactEmailColumnIndex = emailCursor
            ...
            final Cursor addressCursor = managedQuery(
                    ...
                    addressProjection, ContactsContract.Data.CONTACT_ID + "=?", new String[] {
                        String.valueOf(contactId)
                    }, null);
